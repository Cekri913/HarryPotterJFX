    ...
    public void updateEnemy() {
        switch (id){
            case 2:
                this.name="BASLIC";
                this.health=45;
                this.avatar= new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/basilic.png")));
                break;
            case 3:
                this.name="LES DETRAQUEURS";
                this.health=50;
                this.avatar= new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/hijackers.png")));
                break;
            case 4:
                this.name="Peter PETTIGREW & VOLDEMORT";
                this.health=140;
                this.avatar= new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/Peter_Pettigrew.png")));
                break;
            case 5:
                this.name="Dolores Ombrage";
                this.health=70;
                this.avatar= new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/Dolores_Ombrage.png")));
                break;
            case 6:
                this.name="Les Mangemorts";
                this.health=75;
                this.avatar= new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/mangemorts.png")));
                break;
            case 7:
                this.name="Bellatrix Lestrange and Voldemort";
                this.health=160;
                this.avatar= new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/voldemort.png")));
                break;
            case 1:
            default:
                this.name="TROLL";
                this.health=30;
                this.avatar= new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/troll.png")));
                break;
        }
